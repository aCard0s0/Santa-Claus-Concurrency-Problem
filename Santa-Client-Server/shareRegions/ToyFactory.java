...
public class ToyFactory {
    ...
    //  Construtor
    public ToyFactory(RepositoryStub log) {
        this.log = log;
        mutex = new Semaphore();
        mutex.up();                                                     // verde
        try {
    ...
    public int needAdvice(int idGnome) {
        ...
        ((FactoryProxy) Thread.currentThread()).setGnomeState(GnomeStates.WISHINGTTOMEET);
        ...
        if (nGnomes < General.MAX_FIFO){
            ...
            ((FactoryProxy) Thread.currentThread()).setGnomeState(GnomeStates.JOINGROUP);
    ...
    public void goBackToWork(int idGnome){
        ...
        mutex.down();
        ((FactoryProxy) Thread.currentThread()).setGnomeState(GnomeStates.WORKING);
