...
public class TripAroundWorld {
    ...
    //  Construtor
    public TripAroundWorld(InfoRepository log) {
        this.log = log;
        try {
    ...
    public void harnessReindeers() {
        ...
        mutex.down();
        ((Santa) Thread.currentThread()).setSantaState(SantaStates.DISTRIBUTINGGIFTS);
    ...
    public void groupAtSledge(int idReindeer){
        ...
        mutex.down();
        ((Reindeer) Thread.currentThread()).setReindeerState(ReindeerStates.PULLINGSLEDGE);
